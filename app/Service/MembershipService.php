...
class MembershipService implements MembershipServiceInterface
{
    // public function __construct(
        ...
        public function store(array $membership)
        {
            ...
            $item = Membership::create($membership);
            return $item;
        }
        ...
        public function update(array $membership, int $id)
        {
...
// dd($membership);
            ...
            $member->membership_type = $membership['up_membership_type'];
            $member->membership_price = $membership['up_membership_price'];
            $member->status = $membership['up_status'];
            $member->save();

            // $updatedItem = $item->update($membership);
            return $member;
        }
