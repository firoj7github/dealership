                    ...
                    <div class="col-md-12">
                        <div class="card shadow p-4">
                            ...
                            <div class="card-header">
                                <a href="{{ route('admin.listing') }}" style="font-size: 35px" title="back to list"><i
                                ...
                                <form id="edit_from_submit" action="{{ route('store.inventory')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    background-color: rgb(233, 26, 26);">
                                        ...
                                        background-color: white;">
                                            ...
                                            <div>
                                                <h5>File Upload</h5>
                                                <input type="file" name="images[]" multiple accept="image/ <span style="color: red; font-weight:bold;">*</span>">
                                            </div>
