        ...
        <div class="container-fluid" id="contentToConvert">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            @if ($invoices && !empty($invoices[0]->inventory->user->id))
                            <a href="#" class="btn btn-primary float-right " id="generatePdfButton">
                                <i class="fa-solid fa-file-invoice-dollar"></i> Create Invoice
                            </a>
                            <a href="#" class="btn btn-primary float-right " id="generatePdfButton" style="margin-right: 4px" >
                                <i class="fa-solid fa-file-invoice-dollar"></i> PDF Invoice
                            </a>
                        @else
                ...
                <div class="col-md-12">
                    ...
                    <table width="100%" style="font-family: sans-serif; " cellpadding="10" >
                        <tr>
                            <td width="100%" style=" font-size: 14px;  padding: 40px;">
                                ...
                                @if ($invoices)
                                @isset($invoices[0]->inventory->user)
                                <p>{{ $invoices[0]->inventory->user->username ?? '' }}</p>
                                <p>Contact Name - {{ $invoices[0]->inventory->user->username ?? '' }}</p><br/>
                                <p>+1 {{ $invoices[0]->inventory->user->phone ?? '' }}</p>
                                <p>{{ $inventories[0]->inventory->user->email ?? '' }}</p>
                            ...
                            <td  width="100%" style="font-size: 14px;  padding: 40px; ">
                              <p> <span style="font-weight: bold">Invoice No:</span> {{$invoices[0]->invoice_id}}</p>
                            @php
                            ...
                            @endphp
                             ...
                             <p style="margin:2px;"> <a href="#" target="_blank" style="color:#2FB4CC"> <i class="fa-regular fa-credit-card" style="margin-right: 3px"></i> Pay Securely Online</a></p>
                            </td>
                        </tr>

                    </table>
                    <form action="{{route('admin.invoice.new.store')}}" method="post" id="CreateInvoiceForm">
                        @csrf
                    <table class="items table table-bordered" width="100%" style="font-size: 14px;"
                        ...
                        <thead >
                            <tr style="background-color: #EB172C;color:white;font-weight:bold">
                                <td width="5%" style="text-align: left;"><strong>S.N</strong></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding:3px 7px; line-height: 20px;">{{$invoice->inventory->title}}
                                ...
                                <td style="padding:3px 7px; line-height: 20px;">
                                    <input type="date" name="end_date[]" class="form-control" value="{{ \Carbon\Carbon::now()->addDays(30)->format('Y-m-d') }}">
                                </td> --}}
                                <td style="padding: 3px 7px; line-height: 20px;"><input type="text" name="amount[]" class="form-control amount-input" value="{{($invoice->price)? $invoice->price : ''}}"></td>
                            </tr>
                    ...
                    <table width="100%" style="font-family: sans-serif; font-size: 14px;">
                        <tr>
                            <td>
                                ...
                                <table width="20%" align="right" style="font-family: sans-serif; font-size: 14px;">
                                    <tr>
                                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;">
                                            <strong>Subtotal: </strong></td>
                                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;" id="subtotal" class="subtotal"></td>
                                    </tr>
                                    <tr>
                                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;" id="another-total"></td>
                    ...
                    margin-left: 30%;
                    padding: 10px;
                    border-radius: 10px;font-weight:bold;margin-bottom:5px">Pay Securely Online</button><br/>
                    {{-- <img src="{{asset('dashboard/images/visa.jpg')}}" alt="" width="40px" style="margin-left:18%">
                    <img src="{{asset('dashboard/images/mastercard.png')}}" alt="" width="40px" >
                    <img src="{{asset('dashboard/images/discover.png')}}" alt="" width="40px" >
                    <img src="{{asset('dashboard/images/bank-transfer.png')}}" alt="" width="40px" >
                    <img src="{{asset('dashboard/images/american.png')}}" alt="" width="40px" > --}}
                    <ul style="margin-left:20%;margin-top:10px">

                        <li style="float: left;margin-left:10px"> <img src="{{asset('dashboard/images/visa.jpg')}}" alt="" width="30px"></li>
                        <li style="float: left;margin-left:10px"> <img src="{{asset('dashboard/images/mastercard.png')}}" alt="" width="30px" ></li>
                        <li style="float: left;margin-left:10px"> <img src="{{asset('dashboard/images/discover.png')}}" alt="" width="30px" ></li>
                        <li style="float: left;margin-left:10px"><img src="{{asset('dashboard/images/bank-transfer.png')}}" alt="" width="30px" ></li>
                        <li style="float: left;margin-left:10px"> <img src="{{asset('dashboard/images/american.png')}}" alt="" width="30px"></li>
                    </ul>
                    ...
                    <table width="100%" style="font-family: sans-serif; font-size: 14px; position: absolute; bottom:0;margin-top:20px">
                        <br>
                        <tr>
                            <td>
                                <table
                    ...
                    <p style="margin-left:4%; opacity:50%;font-size:12px">PS: Please ignore the credit card payment option. (Charges 3.5% credit card processing/transaction fee).</p>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function updateSubtotalAndTotal() {
            ...
            $('#another-total').text('$' + subtotal.toFixed(2)); // Assuming you want 'another-total' to have the same value as subtotal
