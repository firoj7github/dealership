                ...
                <table width="100%" style="font-family: sans-serif; " cellpadding="10" >
                    <tr>
                        <td width="100%" style=" font-size: 14px;  padding: 40px;">
                            ...
                            <p>{{ $user->username ?? '' }}</p>
                            <p>Contact Name - {{ $user->username ?? '' }}</p><br/>
                            <p>+1 {{ $user->phone ?? '' }}</p>
                            <p>{{ $user->email ?? '' }}</p>
                        ...
                        @endphp
                         ...
                         <p id="top-total"> <span style="font-weight: bold">Amount Due (USD): {{ $products->total}}</span></p>
                        ...
                        <td>
                            ...
                            <table width="20%" align="right" style="font-family: sans-serif; font-size: 14px;">
                                <tr>
                                    ...
                                    <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;" id="subtotal" class="subtotal">{{$products->subtotal}}</td>
                                </tr>
                                <tr>
                                    <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;">
                                    ...
                                    <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;">
                                        <div class="input-group">
                                            <input type="text" name="discount" class="form-control" id="discount" value="{{ ($products->discount) ? $products->discount : '' }}">
                                ...
                                <tr>
                                    ...
                                    <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;">
                                        <input type="text" id="total" value="{{ $products->total}}" disabled>
                                ...
                                <tr>
                                    ...
                                    <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;" id="another-total">
                                    <input type="text" value="{{ $products->total}}" disabled>
                                    </td>
