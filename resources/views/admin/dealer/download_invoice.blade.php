                ...
                <table width="100%" style="font-family: sans-serif; " cellpadding="10" >
                    <tr>
                        <td width="100%" style=" font-size: 14px;  padding: 40px;">
                            ...
                            <p>{{ $invoices[0]->inventory->user->email ?? '' }}</p>
                ...
                <table class="items table table-bordered" width="100%" style="font-size: 14px;"
                    ...
                    <thead >
                        <tr style="background-color: #EB172C;color:white;font-weight:bold">
                            ...
                            <td width="20%" style="text-align: left;"   align="center"><strong>Listing</strong></td>
                            <td width="20%" style="text-align: left;"  align="center"><strong>Quantity</strong></td>
                            {{-- <td width="20%" style="text-align: left;"><strong>Start Date</strong></td>
                            <td width="20%" style="text-align: left;"><strong>End Date</strong></td> --}}
                            <td width="20%" style="text-align: left;"  align="center"><strong>Amount</strong></td>
                        </tr>
                    </thead>
                    <tbody>
                        @php
                        ...
                        <tr>
                            ...
                            <td style="padding:3px 7px; line-height: 20px;"  align="center"> Inventory
                            </td>
                        ...
                        <td>
                            ...
                            <table width="20%" align="right" style="font-family: sans-serif; font-size: 14px;">
                                <tr>
                                    ...
                                    <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;" id="subtotal" class="subtotal">{{ $total_inventory + $total_slider + $total_banner }}</td>
                                </tr>
                                <tr>
                                    <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;">
