            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <div class="table-responsive dt-responsive">
                        <table id="dom-jqry" class="table  table-bordered nowrap listing-table" style="width: 100%">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-size:14px;">Listing Start</th>
                                    <th style="font-size:14px;">Listing End</th>
                                    <th style="font-size:14px;">Payment Date</th>
                                    <th style="font-size:14px;">Active Till</th>
                                    <th style="font-size:14px;">Feature Till</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size:10px; font-weight:bold; opacity:97%">Null</td>
                                    {{-- @php
