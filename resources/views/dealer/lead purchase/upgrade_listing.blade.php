                        ...
                        <tr>
                            <td width="100%" style=" font-size: 14px;  padding: 40px;">
                                ...
                                @if (!empty($user))
                                        ...
                                        <p>Contact Name - {{ $user->username ?? '' }}</p>
                                        <p>+1 {{ $user->phone ?? '' }}</p>
                                        <p>{{ $user->email ?? '' }}</p>
                    ...
                    <table class="items table table-bordered" width="100%" style="font-size: 14px;"
                                ...
                                <thead>
                                    <tr style="background-color: #EB172C;color:white;font-weight:bold">
                                        ...
                                        <td width="20%" style="text-align: center;" align="center"><strong>Stock#</strong>
                                        </td>
                                        <td width="20%" style="text-align: center;" align="center"><strong>Listing Title</strong>
                                        </td>
                                        <td width="20%" style="text-align: center;" align="center"><strong>Listing Model</strong>
                                        </td>

                                        <td width="20%" style="text-align: center;" align="center">
                                ...
                                <td width="20%" style="text-align: left;"><strong>End Date</strong></td> --}}
                                        <td width="20%" style="text-align: center;" align="center"><strong>Amount</strong>
                                        </td>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <!-- ITEMS HERE -->
                                            ...
                                            @php
                                                $total_lead += 20; // Update the total based on your actual calculation
                                            @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:3px 7px; line-height: 20px;" align="center"> {{$lead->inventories_car->stock}}
                                            </td>
                                            <td style="padding:3px 7px; line-height: 20px;" align="center"> {{ $lead->inventories_car->title}}
                                            </td>
                                            <td style="padding:3px 7px; line-height: 20px;" align="center"> {{ $lead->inventories_car->model}}
                                            </td>
                                            ...
                                            <td style="padding: 3px 7px; line-height: 20px;" align="center"> <input
                                                    type="text" value="{{ $total_lead }}" disabled
                                    ...
                                    <td>
                                        ...
                                        <table width="20%" align="right"
                                            ...
                                            <tr>
                                                ...
                                                <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;"
                                                    >
                                                   <input type="text" id="subtotal" class="subtotal" value="${{ $total_lead}}" disabled />
                                                </td>
                                            </tr>
                                            {{-- <tr>
                                                <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;">
