                        ...
                        <tbody>
                            <tr>
                                <td id="m_-6213805131743743389x_30955800m_7214636301576423636m_-8383321887939428501Logo"
                                    style="padding:20px 5px 10px 33px" valign="top"><img width="80" alt="localcarz.com Logo" src="https://localcarz.com/frontend/images/localcarz.png"
                                        id="m_-62138051317437433891698726120623100001_imgsrc_url_0"
                                        ><br></td>
                            </tr>
                            <tr>
                                <td align="center" style="margin:0;padding:0;height:100%;width:100%">
                                    <table border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" bgcolor="#c72931"
                                                    style="padding:20px;font-family:&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;color:#fff;text-align:center;font-size:25px;border-top:1px solid #dddddd;border-bottom:1px solid #dddddd;vertical-align:top"
                                                    valign="top">We have sent your message to seller<br></td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="color:rgb(87,87,87)"><i><span
                                                                    style="font-family:&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif"><span
                                                                        ...
                                                                        delivered.</span></span></i></span><br></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    valign="top"><b>Source:</b> <a href="http://localcarz.com"
                                                        target="_blank"
                                                        data-saferedirecturl="https://www.google.com/url?q=http://carsforsale.com&amp;source=gmail&amp;ust=1698817594175000&amp;usg=AOvVaw0Tf5icET8_-3CQ31R-Qxbt">localcarz.com</a><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <b>Year</b>: {{$data['year'][0]}}<br> <b>Make</b>: {{$data['make'][0]}}<br>
                                                                    <b>Model</b>: {{$data['model'][0]}}<br> <b>Color</b>: {{$data['color'][0]}}<br>
                                                                    <b>Price</b>: ${{$data['price']}}<br> <b>Mileage</b>: {{$data['miles'][0]}}
                                                                    Miles<br> <b>Stock #</b>: {{$data['stock']}}<br> <b>Lot</b>:
                                                                    SKCO Automotive</td>
                                                                <td align="right"
                                                                    style="text-align:right;vertical-align:top;padding-right:50px">
                                                                    <img id="m_-62138051317437433891698726120623100001_imgsrc_url_2"
                                                                        style="width:210px;height:158px;margin:0px 0px 0px 30px" src="{{$data['image']}}"
                                                                        width="210" height="158"><br></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    If you haven't heard anything within 24 hours, please let us know  <a href="{{ route('contact.us',$data['id'])}}"> <br> Contact Us</a></b></span></span></span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left"
                                                                    style="margin:0;padding:0;font-family:&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;color:#575757;font-size:16px;line-height:150%;margin-bottom:0;padding:0 50px 10px 50px">
                                                                    <p>Trade In:</p>
                                                                    <b>Year</b>: {{$data['year'][1]}}<br> <b>Make</b>: {{$data['make'][1]}}<br>
                                                                    <b>Model</b>: {{$data['model'][1]}}<br> <b>Color</b>: {{$data['color'][1]}}<br>
                                                                    <b>Mileage</b>: {{$data['miles'][1]}} Miles
                                                                </td>
                                                            </tr>
                            ...
                            <tr>
                                <td align="center"
                                    ...
                                    valign="top">© 2023 localcarz.com <sup>®</sup> All rights reserved.<br></td>
                            </tr>
