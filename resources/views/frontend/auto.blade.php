                                    ...
                                    <div class="panel-body">
                                        <div class="">
                                            <ul class="list">
                                                ...
                                                <a href=".cat_modal037"
                                                    class="pull-right" data-toggle="modal"><strong >View
                                                        All</strong></a>
                                            </ul>
                                    ...
                                    <div class="panel-body recent-ads">
                                        ...
                                        <div class="recent-ads-list">
                                            <div class="recent-ads-container">
                                                ...
                                                @php
                                                    $modifiedBodyString = str_replace(' ', '+', $related_ad->body);
                                                    $url_id = $related_ad->year.'-'.$related_ad->make.'-'.$related_ad->model.'-'.$modifiedBodyString.'-'.$related_ad->stock;
                                                @endphp
                                                    <a href="{{ route('auto.details',['vin' =>$related_ad->vin, 'id' => $url_id]) }}"
                                                ...
                                                <div class="recent-ads-list-content">
                                                    ...
                                                    <h3 class="recent-ads-list-title">
                                                        <a
                                                            href="{{ route('auto.details',['vin' =>$related_ad->vin, 'id' => $url_id]) }}">{{ $related_ad->title }}</a>
                                                    </h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content ">
            <div class="modal-header">
                ...
                <h3 class="modal-title text-center"> Select Body </h3>
            </div>
...
<!-- Body modal end -->
<!-- =-=-=-=-=-=-= Body Modal=-=-=-=-=-=-= -->
<div class="search-modal modal fade cat_modal036_mobil" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content ">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span
...
<div class="search-modal modal fade cat_modal037_mobile" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-block btn-block" data-dismiss="modal">Select</button>
            </div>
        </div>
    </div>
</div>
...
<div class="input-box">
    ...
    <div class="max-box">
        <div class="input-wrap">
                                    ...
                                    <div class="panel-body">
                                        <div class="">
                                            <ul class="list">
                                                ...
                                                @if($body_count >= 9)
                                                <a href=".cat_modal036_mobil" data-toggle="modal"
                                                    class="pull-right"><strong>View
                                                        All</strong></a>
                                                @endif
            ...
            <div style="background-color: #ddabab;" class="modal-footer">
                <button style="padding-left:15px!imporatant; padding-right:10px!important;" type="button" class="btn btn-default close-btn" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary rounded" id="apply-btn" data-dismiss="modal">Apply</button>
