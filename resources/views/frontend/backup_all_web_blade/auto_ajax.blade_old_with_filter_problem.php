                              ...
                              <div class="ads-list-archive">
                                 ...
                                 <div class="col-lg-5 col-md-5 col-sm-5 no-padding">
                                    ...
                                    <div class="ad-archive-img">
                                       <a href="{{ route('auto.details', $inventory->id) }}">
                                 ...
                                 <div class="col-lg-7 col-md-7 col-sm-7 no-padding">
                                    ...
                                    <div class="ad-archive-desc">
                                       ...
                                       <img alt="featured image" class="pull-right" src="{{asset('frontend/images/package4.png')}}">
                                       @endif
                                       {{--@if($inventory->user->package && $inventory->is_feature == 1)
                                       ...
                                       <!-- Title -->
                                       <h3>
                                        <a class="car-title" href="{{ route('auto.details', $inventory->id) }}"  id="inventory_title">{{ $inventory->title }}</a>
                                       </h3>
                                       <!-- Category -->
                                       <div class="category-title"> 
                                        <span>
                                            <h4>
                                                <strong style="color:black">{{ $inventory->dealers->dealer_name }} </strong> 
                                            </h4>
                                        </span>
                                       ...
                                       <div class="ad-price-simple"> {{ $inventory->price_formate }} 
                                        <small class="payment-price_auto">
                                            <sup class="doller-info">$</sup>
                                            {{ $inventory->payment_price }}/ {{'mo*'}}
                                        </small>
                                       </div>
                                       <div class="clearfix archive-history">
                                          <div class="last-updated">Updated : {{ $dato_formate->diffForHumans()}}</div>
                                          
                                          <div class="ad-meta"> 

                                            <a href="javascript:void(0);" data-id="{{ $inventory->id }}" class="compare_listing" ><i style="margin-left: 10px" class="fa fa-compress "></i></a>
                                            @php
                                            $countWishList = 0;
                                            @endphp
                                            ...
                                            <a class="btn btn-success"><i class="fa fa-phone"></i> View Details. </a> --}}
                                            ...
                                            <a class="btn btn-success check_availability" data-inventoryid="{{ $inventory->id }}">Check Availability</a>
                                         </div>
                                       </div>
                                    </div>
                                    <!-- Ad Desc End -->
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-6 p-4">
                                                    <form style="background-color: #d6d6d6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 col-sm-6 col-xs-12 " style="margin-top:20px">
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <span class="invalid-feedback1 text-danger" role="alert"></span>
                                                                ...
                                                                <div class="col-md-6 col-sm-6 col-xs-12 " style="margin-top:20px">
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <span class="invalid-feedback2 text-danger" role="alert"></span>
                                                                ...
                                                                <div class="col-md-6 col-sm-6 col-xs-12 ">
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <span class="invalid-feedback3 text-danger" role="alert"></span>
                                                                ...
                                                                <div class="col-md-6 col-sm-6 col-xs-12 ">
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <span class="invalid-feedback4 text-danger" role="alert"></span>
                                                                ...
                                                                <div class="col-md-12 col-sm-12 col-xs-12 ">
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <span class="invalid-feedback5 text-danger" role="alert"></span>
