...
{{--<div class="banner-info">
    ...
    <!-- =-=-=-=-=-=-= Home Banner End =-=-=-=-=-=-= -->
         ...
         <div class="ms-slide slide-1"  data-delay="5">
            ...
            <img src="js/masterslider/style/blank.gif" data-src="{{asset('frontend/images/333.jpg')}}" alt="Master Slider"
                                        ...
                                        <div class="search-form pull-left">
                                            <div class="search-form-inner ">
                                                <div class="col-md-3 col-sm-6 col-xs-6 dropdown-pad no-padding">
                                                    ...
                                                    <select class="form-control select2" area-hidden="false !important"
        ...
        <div class="col-md-12 col-xs-12 col-sm-12">
            ...
            <div class="col-md-4 col-xs-12 col-sm-6 ">
                <div class="category-grid-box-1" >
                    ...
                    <div class="image">
                        <a title="" href="{{ route('auto.details',$inventory->id) }}">
                          @if ($inventory->image)
                    ...
                    <div class="short-description-1 clearfix">
                        ...
                        @endphp
                        <h3><a title="" href="{{ route('auto.details',$inventory->id) }}"><strong>{{ $title_info_data }}</strong></a>
                        </h3>
                ...
                <div class="sell-box-grid">
                    ...
                    <div class="text-center">
                        <img class="img-responsive wow slideInLeft center-block" data-wow-delay="0ms"
                            data-wow-duration="2000ms" src="{{ asset('/frontend') }}/images/banner-3.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                <div class="sell-box-grid">
                    ...
                    <div class="text-center">
                        <img class="img-responsive wow slideInRight center-block" data-wow-delay="0ms"
                            data-wow-duration="2000ms" src="{{ asset('/frontend') }}/images/banner-4.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="favourite_add_auth_modal" tabindex="-1" aria-labelledby="exampleModalLabel33"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title fs-5" id="exampleModalLabel33">Add Your Favorites</h3>
