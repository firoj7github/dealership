        ...
        <div class="listingTopFilterBar">
            <div class="col-md-7 col-xs-12 col-sm-7 no-padding">
                <ul class="filterAdType">
                    <li class="active"><a href="">All ads <small>({{ $totalCount }})</small></a>
                    </li>
            ...
            <div class="ads-list-archive">
                ...
                <div class="col-lg-7 col-md-7 col-sm-7 no-padding">
                    ...
                    <div class="ad-archive-desc">
                        ...
                        <!-- Title -->
                        <h3><a class="car-title" href="{{ route('auto.details', $inventory->id) }}"
                        ...
                        <ul class="short-meta list-inline">
                            <li><i class="flaticon-dashboard" title="Mileage"></i><strong style="color:black"> &nbsp;
                                    {{ $inventory->miles }}
                                    miles</strong></li>
                            <li><i class="flaticon-gas-station-1" title="Fuel"></i> &nbsp;
                                {{ $inventory->fuel }}</li>
                            <li><i class="flaticon-key" title="Transmission"> </i>&nbsp;
                                {{ $inventory->transmission }} </li>
                            <li><i class="flaticon-engine-2" title="Engine"></i> &nbsp;
                                {{ $inventory->engine_description }}</li>
                            <li><i class="flaticon-car-2" title="Drive Train"></i>&nbsp;{{ $inventory->drive_train }}
                            </li>
                            <li><i class="flaticon-car-2" title="Body"></i>&nbsp;{{ $inventory->body_formated }}</li>
                        </ul>
                        <!-- Ad History -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 ">
                                                <div class="form-group ">
                                                    ...
                                                    <input placeholder="Cell* " class="form-control phone" type="text"
