...
<meta property="og:url" content="{{ route('auto.details', ['vin'=> $inventory->vin,'id'=> $url_id]) }}">
@endpush
@push('css')
                    ...
                    <div class="col-md-12 col-xs-12 col-sm-12">
                        <div class=" breadcrumb-link back-home">
                            <ul>
                                ...
                                <li><a href="{{ route('autos') }}">All Categories</a></li>
                                <li><a href="{{ route('autos', ['make' => $inventory->make, 'min' => '', 'max' => '']) }}">{{ $inventory->make }}</a></li>
                                <li><a href="{{ route('autos', ['make' => $inventory->make,'model' => $inventory->model, 'min' => '', 'max' => '']) }}">{{ $inventory->model }}</a></li>
                                <li><a href="{{ route('autos', ['make' => '','model' => '','min-year' => $inventory->year, 'min' => '', 'max' => '']) }}">{{ $inventory->year }}</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 photos-second">
                                ...
                                @endphp
                                    ...
                                    @if($countWishList > 0)
                                    <i class="fa fa-heart btn save-ad love" id="wishlist-icon" title="Wishlist"
                                        style="color:red,;font-weight:bold !important;"></i>
                                    @else
                                    <i  class="fa fa-heart btn save-ad love"
                                    style="color:black!important; font-weight:bold !important;"
                                      id="wishlist-icon" title="Wishlist"></i>
                                    @endif
                                </a>
                        ...
                        <div class="posts-masonry">
                            ...
                            <div class="ads-list-archive">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-5 no-padding">
                                    <!-- Img Block -->
                                    @php
                                        $modifiedBodyString = str_replace(' ', '+', $invent->body);
                                        $url_id = $invent->year.'-'.$invent->make.'-'.$invent->model.'-'.$modifiedBodyString.'-'.$invent->stock;
                                    @endphp
                                    <div class="ad-archive-img">
                                        <a href="{{ route('auto.details',['vin' =>$invent->vin, 'id' => $url_id]) }}">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7 no-padding">
                                    ...
                                    <div class="ad-archive-desc">
                                        ...
                                        <div class="clearfix archive-history">
                                            ...
                                            <div class="ad-meta"> <a  class="btn save-ad"><i class="fa fa-heart"></i>
                                                    Add Favorite</a>
                                                    <a href="{{ route('auto.details',['vin' =>$inventory->vin, 'id' => $url_id]) }}" class="btn btn-success"><i class="fa fa-eye"></i>View Details.</a> </div>
                                        </div>
                                    </div>
                                    <!-- Ad Desc End -->
                                </div>
                ...
                <div class="sidebar">
                    ...
                    <div class="widget">
                        <div class="widget-heading">
                            <h4 class="panel-title"><a>Recent Lists</a></h4>
                        </div>
                            ...
                            <div class="recent-ads-list">
                                <div class="recent-ads-container">
                                    <div class="recent-ads-list-image">
                                        @php
                                            $modifiedBodyString = str_replace(' ', '+', $invento->body);
                                            $url_id = $invento->year.'-'.$invento->make.'-'.$invento->model.'-'.$modifiedBodyString.'-'.$invento->stock;
                                        @endphp
                                        <a href="{{ route('auto.details',['vin' =>$invento->vin, 'id' => $url_id]) }}"
                                    ...
                                    <div class="recent-ads-list-content">
                                        <h3 class="recent-ads-list-title">
                                            ...
                                            <a
                                                href="{{ route('auto.details',['vin' =>$invento->vin, 'id' => $url_id]) }}">{{ $invento->title }}</a>
                                        </h3>
...
<div class=" emailmodalpopup">
    ...
    {{-- <a  href="#"><i class="fa fa-heart btn save-ad love-icon" id="wishlist-icon" title="Wishlist"></i></a> --}}
                                ...
                                $countWishList = App\Models\Favourite::countWishList($inventory->id,$userIP);
                                @endphp
                                ...
                                <a href="javascript:void(0);" class="update_wishlist"
                                    ...
                                    <i class="fa fa-heart btn save-ad love-icon" id="wishlist-icon" title="Wishlist"
                                        style="color:red"></i>
                                    @else
                                    <i class="fa fa-heart btn save-ad love-black"
                                    style="color:black !important" id="wishlist-icon" title="Wishlist"></i>
                                    @endif
                                </a> --}}
        ...
        success: function(response) {
            ...
            if (response.action === 'add') {
                $('a[data-productid=' + inventory_id + ']').html(
                    `<i class="fa fa-heart btn save-ad love" id="wishlist-icon" title="Wishlist" style="color:red"></i>`
                );
                toastr.success(response.message);
            } else if (response.action === 'remove') {
                $('a[data-productid=' + inventory_id + ']').html(
                    ` <img width="20px" style="margin-top:17px; margin-left:26px;" src="{{asset('frontend/images/black.jpg')}}" id="wishlist-icon"  alt="" />`
                    // `<i class="fa fa-heart-o btn  save-ad" style="color:black !important"  id="wishlist-icon" title="Wishlist" ></i>`
                );
